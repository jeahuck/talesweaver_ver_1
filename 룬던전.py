...
def worker_2(name):
    ...
    if hwnd:
        for i in range(1, 30000000):
            ...
            if select_img('im/rune/floor1.png', hwnd, win_left, win_top) : continue
            if select_img('im/rune/floor2.png', hwnd, win_left, win_top) : continue
            if select_img('im/rune/floor3.png', hwnd, win_left, win_top) : continue
            if select_img('im/rune/floor4.png', hwnd, win_left, win_top) : continue
