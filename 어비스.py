...
def worker_2(name):
    ...
    if hwnd:
        for i in range(1, 30000000):
            ...
            if select_img('im/Abyss/yes2.png', hwnd, win_left, win_top - 10) :
                send_background_click(hwnd, VK_RETURN)
                continue
            #퍼런색 버튼
            if select_img('im/Abyss/btn1.png', hwnd, win_left, win_top) : continue
            if select_img('im/Abyss/Jellybee3.png', hwnd, win_left, win_top) : continue
            if select_img('im/Abyss/Jellybee2.png', hwnd, win_left, win_top) : continue
            if select_img('im/Abyss/Jellybee.png', hwnd, win_left, win_top) : continue
            if select_img('im/Abyss/yes.png', hwnd, win_left, win_top - 10) : continue
            if select_img('im/Abyss/skeleton.png', hwnd, win_left, win_top - 5) : continue
            if select_img('im/Abyss/re_game2.png', hwnd, win_left, win_top - 5) : continue
            if select_img('im/Abyss/re_game.png', hwnd, win_left, win_top - 10) :
                send_background_click(hwnd, VK_RETURN)
                continue
